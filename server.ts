    ...
    if (GROQ_TOOLS.has(tool)) {
      ...
      switch (tool) {
        case "Slides":
          ...
          userPrompt = `${contextBlock}\n\nCRITICAL INSTRUCTION: First, thoroughly analyze the chapter content provided above. Identify all major sections, topics, concepts, and sub-topics in the chapter. Then create a comprehensive slide deck that covers each section with appropriate detail.\n\nDetermine the number of slides dynamically based on the chapter's depth and structure — do not force a fixed count. Aim for 1 slide per major section/topic plus 1 introduction slide and 1 summary slide. A detailed chapter may need 8-15+ slides to cover everything properly.\n\nEach slide must have:\n- "title": a clear slide heading representing that section/topic\n- "bullets": 2-5 key teaching points taken directly from the provided text\n- "visualCue": a specific description of what the teacher should draw, write, or display on the board\n\nDo NOT skip any section of the chapter. Cover the entire chapter end-to-end in a pedagogically sequential order. Start with an introduction/warm-up, build through each core concept, and end with a summary or quick activity.`;
          break;
